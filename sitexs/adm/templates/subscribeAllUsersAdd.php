...
<p align="center"><input type="button" value="<?php __("Назад") ?>" style="width: auto;" onclick="javascript: history.go(-1);">&nbsp;&nbsp;<input type="submit" value="<?php __("Сохранить") ?>" style="width: auto;"></p>
	<table border="0" cellspacing="0" cellpadding="5" width="100%">
		...
		<tr>
			...
			<td><input maxlength="255" name="fields[name]" size="40" value="$data[name]" title="<?php __("Имя") ?>"></td>
		</tr>
		<tr>
			<td><b>E-mail&nbsp;*</b></td>
...
<legend style="background-color: #F8F8F3;padding: 0.5em;border: 1px solid silver;margin-bottom: 0.5em;"><?php __("Списки рассылки") ?></legend>
$lists
</fieldset>
$approved
<p align="center"><input type="button" value="<?php __("Назад") ?>" style="width: auto;" onclick="javascript: history.go(-1);">&nbsp;&nbsp;<input type="submit" value="<?php __("Сохранить") ?>" style="width: auto;"></p>
