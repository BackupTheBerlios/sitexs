...
<li><?php echo __("Site IP") ?>: <strong><?php echo $HTTP_SERVER_VARS["SERVER_ADDR"] ?></strong></li>
<li><?php echo __("Web-server") ?>: <strong><?php echo $HTTP_SERVER_VARS["SERVER_SOFTWARE"] ?></strong></li>
