...
<tr>
	<td style="background: ButtonFace; border-top: 1px solid ButtonHighlight;" align="right"><input type="button" value="&lt; Назад" style="width: auto;" onclick="javascript: history.go(-1);">&nbsp;&nbsp;<input type="submit" value="Далее &gt;" style="width: auto;"></td>
</tr>
</table>
</form>
	</td>
