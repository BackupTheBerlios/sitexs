...
<tr>
	<td width="100%"><h3 style="margin: 0px;"><?php __("Список рассылки") ?> &laquo;$listName&raquo;</h3></td>
...
<p align="center"><input type="button" value="<?php __("Назад") ?>" style="width: auto;" onclick="javascript: history.go(-1);">&nbsp;&nbsp;<input type="submit" value="<?php __("Сохранить") ?>" style="width: auto;"></p>
	<table border="0" cellspacing="0" cellpadding="5" width="100%">
		...
		<tr>
			...
			<td><input maxlength="255" name="fields[subj]" size="40" value="$data[subj]" title="<?php __("Заголовок") ?>"></td>
		</tr>
		<tr>
			<td><?php __("Текст") ?></td>
		...
		<tr>
			<td>HTML</td>
			<td><textarea cols="40" name="fields[html]" rows="20">$data[html]</textarea><br><a href="#" onClick="return showVE('$data[id]', 'fields[html]');"><?php __("Визуальный редактор") ?></a></td>
		</tr>
	</table>
