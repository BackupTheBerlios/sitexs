...
<p align="center"><input type="submit" value="Сохранить" style="width: auto;" onclick="return validateForm();"></p>
<table border="0">
<tr>
	<th>Поле</th>
	<th>Значение</th>
...
<tr>
	<td><b>E-mail для тестовой рассылки&nbsp;*</b></td>
	<td><input type="text" name="fields[test_email]" value="$data[test_email]"></td>
</tr>
<tr>
	<td><b>Относительный URL подписки&nbsp;*</b></td>
	<td><input type="text" name="fields[url]" value="$data[url]"></td>
</tr>
<tr>
	<td><b>Текстовая версия&nbsp;*</b></td>
	<td><textarea tabindex="0" name="fields[text]" rows="7" cols="40" title="Текстовая версия">$data[text]</textarea></td>
</tr>
<tr>
	<td><b>HTML-версия *</b></td>
	<td><textarea tabindex="1" name="fields[html]" rows="7" cols="40" title="HTML-версия">$data[html]</textarea><br><a href="#" onClick="return showVE('$data[id]', 'fields[html]');">Визуальный редактор</a></td>
</tr>

<tr>
	<td><b>Подтверждение *</b></td>
	<td><textarea tabindex="2" name="fields[confirm]" rows="7" cols="40" title="Подтверждение">$data[confirm]</textarea><br><a href="#" onClick="return showVE('$data[id]', 'fields[confirm]');">Визуальный редактор</a></td>
</tr>
</table>
<p align="center"><input type="submit" value="Сохранить" style="width: auto;"></p>
</form>
