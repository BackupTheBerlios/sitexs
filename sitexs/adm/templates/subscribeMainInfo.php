...
<p align="center"><input type="submit" value="<?php __("Сохранить") ?>" style="width: auto;" onclick="return validateForm();"></p>
<table border="0">
<tr>
	<th><?php __("Поле") ?></th>
	<th><?php __("Значение") ?></th>
</tr>
<tr>
	<td><?php __("E-mail ОТ") ?></td>
	<td><input type="text" name="fields[email_from]" value="$data[email_from]"></td>
</tr>
<tr>
	<td><b><?php __("E-mail для тестовой рассылки") ?>&nbsp;*</b></td>
	<td><input type="text" name="fields[test_email]" value="$data[test_email]"></td>
</tr>
<tr>
	<td><b><?php __("Относительный URL подписки") ?>&nbsp;*</b></td>
	<td><input type="text" name="fields[url]" value="$data[url]"></td>
</tr>
<tr>
	<td><b><?php __("Текстовая версия") ?>&nbsp;*</b></td>
	<td><textarea tabindex="0" name="fields[text]" rows="7" cols="40" title="<?php __("Текстовая версия") ?>">$data[text]</textarea></td>
</tr>
<tr>
	<td><b><?php __("HTML-версия") ?> *</b></td>
	<td><textarea tabindex="1" name="fields[html]" rows="7" cols="40" title="<?php __("HTML-версия") ?>">$data[html]</textarea><br><a href="#" onClick="return showVE('$data[id]', 'fields[html]');"><?php __("Визуальный редактор") ?></a></td>
</tr>

<tr>
	<td><b><?php __("Подтверждение") ?> *</b></td>
	<td><textarea tabindex="2" name="fields[confirm]" rows="7" cols="40" title="<?php __("Подтверждение") ?>">$data[confirm]</textarea><br><a href="#" onClick="return showVE('$data[id]', 'fields[confirm]');"><?php __("Визуальный редактор") ?></a></td>
</tr>
</table>
<p align="center"><input type="submit" value="<?php __("Сохранить") ?>" style="width: auto;"></p>
</form>
